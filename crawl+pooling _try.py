...
def worker(url_single):
    ...
    request =urllib.request.Request(url=url_single,headers=headers)
...
if __name__ == '__main__':
    ...
    f = open('F:\\万方文献爬取\\wf_mag_urlnew近5年.txt', 'r')
    URL_NEW_ALL = eval(f.read())

    # url_single=['http://med.wanfangdata.com.cn/Paper/Detail/PeriodicalPaper_jcyxylc201703014','http://med.wanfangdata.com.cn/Paper/Detail/PeriodicalPaper_jcyxylc201703017']
    for i in URL_NEW_ALL:
        pool.apply(worker,[i])
        # worker(i)
